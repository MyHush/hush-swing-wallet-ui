...
class AddressBookPanel extends JPanel {
    ...
    AddressBookPanel(SendCashPanel sendCashPanel, JTabbedPane tabs) throws IOException {
    ...
    private JPanel buildButtonsPanel() {
        ...
        sendCashButton = new JButton("Send HUSH");
    ...
    private class AddressMouseListener extends MouseAdapter {
        ...
        public void mousePressed(MouseEvent e) {
            ...
            JMenuItem sendCash = new JMenuItem("Send HUSH to " + entry.name);
